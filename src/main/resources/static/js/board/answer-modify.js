{
    ...
    $writeBtn.addEventListener('click', function () {
        ...
        form.setAttribute("action", "/board/answer-modify"); //요청 보낼 주소

        let contentField = document.createElement("textarea");
        contentField.setAttribute("name", "answerContent");
        contentField.innerText = contentHtml;
        form.appendChild(contentField);

        let questionIdField = document.createElement("input");
        questionIdField.setAttribute("type", "hidden");
        questionIdField.setAttribute("name", "questionId");
